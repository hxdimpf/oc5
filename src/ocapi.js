...
export async function ocInsertCache(data) {
  await pool.query(`INSERT INTO caches (uuid, user_id, name, longitude, latitude, type, status, country, date_hidden, size, difficulty, terrain, node, date_created, last_modified, listing_last_modified, meta_last_modified)
